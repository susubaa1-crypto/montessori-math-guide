// 몬테소리 매쓰 30주 가이드 데이터
const GUIDE_DATA = {
  startDate: "2026-01-06", // 1주차 시작일 (화요일)
  ...
  // 완주 선물
  rewards: [
    { tier: "라운지 VIP", badge: "🏆", requirement: "매주 인증 90% 이상(27회) + 카페 후기 1회", prize: "배민 상품권 5만원" },
    { tier: "라운지 패밀리", badge: "⭐", requirement: "매주 인증 80%(24회) + 카페 후기 1회", prize: "배민 상품권 2만원" },
    { tier: "라운지 게스트", badge: "🎁", requirement: "카페 후기 5회 이상", prize: "배민 상품권 1만원" },
  ],
  ...
  participants: [
    ...
    "배은주", "서미건", "서아", "성혜경", "손지현",
    "송서우", "슬비", "신이슬", "신재은", "윤태경",
    "이슬", "이슬기", "이은용", "이인하", "이주은", "이창화",
    "임소원", "임에스더", "쟈니맘", "전상아", "전채연",
    "전현정", "정다희", "정수연", "정주희", "정희엽",
    "조윤희", "지유정", "최문희", "최윤실", "하하맘",
    "한지영",
  ],
