...
function renderRewards() {
  ...
  const tierClasses = ['vip', 'family', 'guest'];
  container.innerHTML = GUIDE_DATA.rewards.map((r, i) => `
    <div class="reward-card ${tierClasses[i]}">
      <div class="reward-badge">${r.badge}</div>
      <div class="reward-tier">${r.tier}</div>
      <div class="reward-requirement">${r.requirement}</div>
